...
import com.hitesh.automatahon.builder.selenium.enums.LocateBy;
import com.hitesh.automatahon.builder.selenium.enums.TextBy;
import com.hitesh.automatahon.builder.selenium.manager.SeleniumObjectManager;
...
public class ElementHelper {
    ...
    public void click(WebElement element) {
        try {
            ...
            // Move to Element
            ActionHelper.getInstance().moveToElement(element);
    ...
    public boolean waitForJStoLoad(int seconds) {
        try {
            final JavascriptExecutor jse = SeleniumObjectManager.getInstance().getJSExecutor();
            WebDriverWait wait = SeleniumObjectManager.getInstance().getWaitObject(seconds);
