package com.hitesh.automatahon.builder.selenium.browserProfiles;
...
public class ChromeProfileBuilder {
    ...
    private static ThreadLocal<ChromeProfileBuilder> instance = new ThreadLocal<>();
